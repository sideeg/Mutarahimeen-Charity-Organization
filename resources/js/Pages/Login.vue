...
import { HeartHandshake, AlertTriangle } from "lucide-vue-next";
...
<template>
    ...
    >
        ...
        <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
            ...
            >
                <!-- General credential / account-status banner -->
                <div
                    v-if="form.errors.credentials || form.errors.account"
                    class="mb-6 flex items-start gap-3 bg-red-950/40 border border-red-800/60 text-red-300 text-sm px-4 py-3 rounded-lg"
                >
                    <AlertTriangle class="w-5 h-5 flex-shrink-0 mt-0.5" />
                    <span>{{
                        form.errors.account || form.errors.credentials
                    }}</span>
                </div>
                ...
                <form @submit.prevent="submit" class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="mt-1 flex items-center gap-3">
                            ...
                            <input
                                ...
                                :class="{
                                    'border-red-500': form.errors.captcha,
                                }"
                            />
                        </div>
                        <p
                    ...
                    <div>
                        <button
                            ...
                            class="w-full flex justify-center py-2.5 px-4 border border-transparent rounded-md shadow-sm text-sm font-bold text-white bg-orange-500 hover:bg-orange-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 transition cursor-pointer disabled:opacity-60"
                        >
                            {{
                                form.processing
                                    ? "جاري التحقق..."
